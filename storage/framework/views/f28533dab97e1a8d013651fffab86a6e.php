        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <?php if(!request()->routeIs('dashboard')): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="absolute left-2 top-1/2 -translate-y-1/2 text-xl font-bold">
                        ←
                    </a>
                <?php endif; ?>
...
</nav><?php /**PATH C:\xampp\htdocs\NewAllin\allin-ruway\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>
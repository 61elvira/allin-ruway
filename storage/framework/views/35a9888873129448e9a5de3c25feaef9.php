        ...
        <?php $__empty_1 = true; $__currentLoopData = $contrataciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contratacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="request-card">
                <div class="request-header">
                    ...
                    <span class="request-status"><?php echo e(ucfirst($contratacion->estado)); ?></span>
                </div>
                ...
                <div class="request-actions">
                    <form action="<?php echo e(route('contrataciones.aceptar', $contratacion->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
                        <button class="accept-btn">Aceptar</button>
                    </form>
                    <form action="<?php echo e(route('contrataciones.rechazar', $contratacion->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\NewAllin\allin-ruway\resources\views/contrataciones/index.blade.php ENDPATH**/ ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $contrataciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contratacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="request-card">
                ...
                <div class="request-body">
                    ...
                    <?php if($contratacion->estado == 'finalizado' && !$contratacion->calificacion): ?>
                        <a href="<?php echo e(route('calificaciones.create', $contratacion->id)); ?>" class="finish-btn">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\NewAllin\allin-ruway\resources\views/contrataciones/mis-contrataciones.blade.php ENDPATH**/ ?>